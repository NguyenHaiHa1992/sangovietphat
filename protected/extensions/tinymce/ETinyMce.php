...
class ETinyMce extends CInputWidget
{
   ...
   *
    ...
    * @var string
    */
   private $fontSizes = array("8px,10px,11px,12px,13px,14px,15px,16px,18px,20px,24px,30px,36px");
...
/* Simple toolbar */
	  $options['theme_advanced_buttons1'] = "{$sc}bold,italic,underline,strikethrough,|,forecolor,backcolor,|,link,unlink,|,code";
	  $options['theme_advanced_buttons2'] = "formatselect,fontselect,fontsizeselect";
	  $options['theme_advanced_buttons3'] = "justifyleft,justifycenter,justifyright,justifyfull,|,bullist,numlist,|,outdent,indent";
	  $options['theme_advanced_buttons4'] = "blockquote,|,charmap,emotions,|,sub,sup,|,media,image";
	  $options['theme_advanced_buttons5'] = "{$c2}tablecontrols";
	  $options['theme_advanced_buttons6'] = "pastetext,pasteword,|,search,replace,|,undo,redo,|,styleprops,del,ins,attribs";
