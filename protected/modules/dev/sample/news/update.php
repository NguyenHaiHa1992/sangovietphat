...
<div class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon"><span><?php iPhoenixLang::admin_t('Update SAMPLe_TRANSLATE');?></span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content form">
		<div>
            ...
            <input type="button" class="button" value="<?php iPhoenixLang::admin_t('Add SAMPLe_TRANSLATE');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/sample/create')?>'"/>
...
setInterval (
     function () {
        ...
        if (status != "on" && autosave == "on") // if no function is running, then run the function
        {
           ...
           $.ajax ({
              url: "<?php echo Yii :: app () -> createUrl ('admin/sample/autoSave',array('id'=>$model->id))?>", // ​​call a function to autosave
              type: "post",
              dataType: "json",
