...
<div class="folder top">
	...
	<div class="folder-header">
		<h1>quản trị Category model</h1>
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon" href=""><span>Tạo mới Category model</span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content form">
	    ...
	    <div class="notice">Đảm bảo  model chưa tồn tại, tên model và dịch nghĩa model chính xác: <span>Viết hoa chữ cái đầu tiên của model, ví dụ "NewsCategory", dịch nghĩa "News categories"</span></div>
		<?php
