<div class="fr menu-tree" style="width: 370px;">
<ul>
	<li><label><b><?php echo iPhoenixLang::admin_t('Product category tree','product');?></b></label></li>
	<li>
		<?php 
		...
		foreach ($list_nodes as $id=>$level){
			...
			if($node->status == ProductCategory::STATUS_DISABLE){
