...
<div class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon" href=""><span>Partner categories</span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
  			...
  			jConfirm(\"Are you sure you want to delete this category?\",\"Notice\",function(r){
	  			if(r==true){
					jQuery.ajax({
						...
						'type':'GET',
						'url':'".iPhoenixUrl::createUrl('admin/partnerCategory/delete')."',
						'cache':false});
	        	};
  			});
        	return false;	
		...
		$('body').on(
  			...
  			function(){
  				jQuery.ajax({
					...
					'type':'GET',
					'url':'".iPhoenixUrl::createUrl('admin/partnerCategory/update')."',
					'cache':false
				});
				return false;
			}
  		...
  		$('body').on(
  			...
  			function(){
  				jQuery.ajax({
        			...
        			'type':'GET',
        			'url':'".iPhoenixUrl::createUrl('admin/partnerCategory/create')."',
        			'cache':false,
        		});
        		return false;
        	}
  		...
  		$('body').on(
  			...
  			function(){
  				jQuery.ajax({
        			...
        			'type':'GET',
        			'url':'".iPhoenixUrl::createUrl('admin/partnerCategory/write')."',
        			'cache':false,
...
$cs->registerScript(
  ...
  "jQuery(
	...
	{ 
		$('body').on(
  			'change',
  			'#PartnerCategory_parent_id',	
  			function(){
  				jQuery.ajax({
  					'data':{parent_id : $(this).val()},
  					'success':function(data){  		
  						if($(\"#PartnerCategory_order_view\")){				
							$(\"#PartnerCategory_order_view\").html(\"\");
							for(var i=1;i<=data;i++){
								...
								$(\"#PartnerCategory_order_view\").append(option);
							}
						}
					},
					'type':'GET',
					'url':'".iPhoenixUrl::createUrl('admin/partnerCategory/updateListOrderView')."',
					'cache':false
				});
				return false;
			}
