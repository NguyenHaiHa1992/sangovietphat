...
<div class="form-setting popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title">Configure parameter</div>
			<div class="folder-content">
				<?php $form=$this->beginWidget('CActiveForm', array('id'=>'form-setting','action'=>iPhoenixUrl::createUrl('admin/setting/write'),'method'=>'post','enableClientValidation'=>true)); ?>	
				<!--begin left content-->
...
<script type="text/jscript">
	$('#form-setting').submit(function(){
		jQuery.ajax({
			...
			'type':'GET',
			'url':'<?php echo iPhoenixUrl::createUrl('admin/setting/write')?>',
			'cache':false
		});
		return false;
	});
