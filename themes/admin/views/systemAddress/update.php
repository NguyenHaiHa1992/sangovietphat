...
<div id="main-content" class="folder top">
	<!--begin name-->
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon" href=""><span><?php echo iPhoenixLang::admin_t('Update SystemAddress');?></span></a></li>
			</ul>
		</div>
	</div>
	<!--end name-->
	<div class="folder-content form">
		<div>
            <input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('List system address','systemAddress');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/systemAddress/index')?>'"/>
            <input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('Add system address','systemAddress');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/systemAddress/create')?>'"/>
                                    ...
                                    <li>
                                            ...
                                            <?php echo $form->dropDownList($model, 'status', 
                                                    array(0 => iPhoenixLang::admin_t('Hide', 'main'),
                                                          1 => iPhoenixLang::admin_t('Show', 'main')), 
