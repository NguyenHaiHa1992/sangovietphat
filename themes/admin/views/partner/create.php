...
<div class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon" href=""><span>Add partner</span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
...
setInterval (
     function () {
        ...
        if (status != "on" && autosave == "on") // if no function is running, then run the function
        {
           ...
           $.ajax ({
              url: "<?php echo Yii :: app () -> createUrl ('admin/partner/autoSave')?>", // ​​call a function to autosave
              type: "post",
              dataType: "json",
