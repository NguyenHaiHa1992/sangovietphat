...
<div class="<?php echo $class;?> popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title">List partners</div>
			<div class="folder-content" style="max-height: 700px;">
				<ul>
					<?php 
						Yii::app()->clientScript->registerScript('search-partner-suggest', "
					 ...
					 <li>
				     	<?php echo $form->label($suggest,'title'); ?>
				       	<?php $this->widget('CAutoComplete', array(
											...
											'htmlOptions'=>array(
												'style'=>'width:230px;',
				       							'name'=>'SuggestPartner[title]'
												),
										)); ?>								
				      </li>
					  <?php 
						$list=array(''=>'All partner categories');
					...
					<li>
						...
						<?php echo $form->dropDownList($suggest,'cat_id',$list,array('style'=>'width:200px','name'=>'SuggestPartner[cat_id]')); ?>
					</li>            
					<li>
					<label>&nbsp;</label> 
	...
	$("#update_suggest").click(
  		function(){  	
			...
			jQuery.ajax({
				...
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/partner/updateSuggest');?>',
				});
			return false;
		});
});
