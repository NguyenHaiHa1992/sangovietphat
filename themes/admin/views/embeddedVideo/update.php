...
<div id="main-content" class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon"><span><?php echo iPhoenixLang::admin_t('Update video');?></span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content form">
		<div>
            <input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('List videos');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/embeddedVideo')?>'"/>
			...
			<ul>
					...
					<div class="row" style="display:none">
						<li>
							...
							<a title="Chọn bài viết" onclick="showPopUp('list_suggest_embeddedVideo');return false;" id="btn-add-product" class="button" style="width: 100px;text-decoration: none;">Chọn</a>			
						</li>
					</div>	
					<div class="row">
						<li>
							<?php echo $form->labelEx($model,'v'); ?>
							<?php echo $form->textField($model,'v',array('style'=>'width:300px;','maxlength'=>'256')); ?>	
					...
					<div class="row">
						<li>
							...
							<?php echo $this->renderPartial('/image/_signupload', array('model'=>$model,'attribute'=>'introimage_id','h'=>49,'w'=>89)); ?>		
					...
					<div class="row">
						<li>
							...
							<?php echo $form->textArea($model,'description',array('style'=>'width:300px; height:80px','maxlength'=>'256')); ?>		
...
<!--end inside content-->
<?php	echo $this->renderPartial('_list_suggest_embeddedVideo', 
								array(
									'class_checkbox'=>'SuggestEmbeddedVideo',
									'class'=>'list_suggest_embeddedVideo',
