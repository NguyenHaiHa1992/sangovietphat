...
<div class="<?php echo $class;?> popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title">List EmbeddedVideos</div>
			<div class="folder-content">
				<ul>
						<?php 
							Yii::app()->clientScript->registerScript('search-embeddedVideo-suggest', "
					 ...
					 <li>
				     	<?php echo $form->label($suggest,'name'); ?>
				       	<?php $this->widget('CAutoComplete', array(
											...
											'htmlOptions'=>array(
												'style'=>'width:230px;',
				       							'name'=>'SuggestEmbeddedVideo[name]'
												),
										)); ?>								
				      </li>
					  <?php 
						$list=array(''=>'All EmbeddedVideo Categories');
					...
					<li>
						...
						<?php echo $form->dropDownList($suggest,'cat_id',$list,array('style'=>'width:200px','name'=>'SuggestEmbeddedVideo[cat_id]')); ?>
					</li>            
					<li>
					<label>&nbsp;</label> 
	...
	$("#update_suggest").click(
  		function(){  	
			...
			jQuery.ajax({
				...
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/embeddedVideo/updateSuggest');?>',
				});
			return false;
		});
});
