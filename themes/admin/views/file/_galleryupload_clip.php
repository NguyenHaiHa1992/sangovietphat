<?php
	...
	array(
        ...
        'config'=>array(
               ...
               'allowedExtensions'=>Clip::$allowedExtensions,//array("jpg","jpeg","gif","exe","mov" and etc...
               'sizeLimit'=>Clip::$sizeLimit,// maximum file size in bytes
               ...
               'template'=> '<div class="qq-uploader">
                			...
                			<div class="qq-upload-button">Select clip</div>
    ...
    "$('.slider-folder').delegate('.close', 'click', function() {
  			...
  			var r=jConfirm(\"Are you sure you want to delete this file?\",\"Confirm deletion?\",function(r){
  				if(r==true){
