<?php $form=$this->beginWidget('CActiveForm', array('id'=>'category-form','enableAjaxValidation'=>true,'clientOptions'=>array('validationUrl'=>$this->createUrl('embeddedVideoCategory/validate')))); ?>	
...
<div class="fl" style="width:500px;">
	<ul>
		...
		<div class="row" <?php if(EmbeddedVideoCategory::MAX_RANK == 1) echo'style="display:none"'?>>
		<li>
		...
		<li>
			...
			<?php
				$list=array(EmbeddedVideoCategory::STATUS_ENABLE=>'Show',EmbeddedVideoCategory::STATUS_DISABLE=>'Hide');
