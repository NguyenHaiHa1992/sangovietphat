...
<div class="<?php echo $class;?> popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title">List Advisors</div>
			<div class="folder-content" style="max-height: 700px;">
				<ul>
					<?php 
						Yii::app()->clientScript->registerScript('search-advisor-suggest', "
					 ...
					 <li>
				     	<?php echo $form->label($suggest,'title'); ?>
				       	<?php $this->widget('CAutoComplete', array(
											...
											'htmlOptions'=>array(
												'style'=>'width:230px;',
				       							'name'=>'SuggestAdvisor[title]'
												),
										)); ?>								
				      </li>
					  <?php 
						$list=array(''=>'All Advisor Categories');
					...
					<li>
						...
						<?php echo $form->dropDownList($suggest,'cat_id',$list,array('style'=>'width:200px','name'=>'SuggestAdvisor[cat_id]')); ?>
					</li>            
					<li>
					<label>&nbsp;</label> 
					<input type="submit" class="button" value="Filt Advisor">
					</li>
					<?php $this->endWidget(); ?>	
					<li>
					  <?php 
	...
	$("#update_suggest").click(
  		function(){  	
			...
			jQuery.ajax({
				...
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/advisor/updateSuggest');?>',
				});
			return false;
		});
});
