...
<div class="<?php echo $class;?> popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title"><?php echo iPhoenixLang::admin_t('List Testing');?></div>
			<div class="folder-content" style="max-height: 700px;">
				<ul>
					<?php 
						Yii::app()->clientScript->registerScript('search-test-suggest', "
					...
					<li>
						...
						<?php echo $form->dropDownList($suggest,'cat_id',$list,array('style'=>'width:200px','name'=>'SuggestTest[cat_id]')); ?>
					</li>            
					<li>
					<label>&nbsp;</label> 
	...
	$("#update_suggest").click(
  		function(){  	
			...
			jQuery.ajax({
				...
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/test/updateSuggest');?>',
				});
			return false;
		});
});
