...
<div class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon"><span><?php iPhoenixLang::admin_t('Add Testing');?></span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
...
setInterval (
     function () {
        ...
        if (status != "on" && autosave == "on") // if no function is running, then run the function
        {
           ...
           $.ajax ({
              url: "<?php echo Yii :: app () -> createUrl ('admin/test/autoSave')?>", // ​​call a function to autosave
              type: "post",
              dataType: "json",
