...
<div class="folder top">
	...
	<div class="folder-header">
		<h1><?php echo iPhoenixLang::admin_t('Testing management');?></h1>
		<div class="header-menu">
			<ul>
				<li class="ex-show"><a class="activities-icon"><span><?php echo iPhoenixLang::admin_t('List Testings');?></span></a></li>
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content">
		<div>
			<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('Testing categories');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/NewsCategory/index')?>'"/>
			<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('Add Testing');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/test/create')?>'"/>
			...
			<div class="fr" style="width:600px;">
				<ul>                   
					...
					<li>
						...
						<?php echo $form->dropDownList($model,'new',array(''=>iPhoenixLang::admin_t('All','main'), 1=>iPhoenixLang::admin_t('Display in new Testing')),array('style'=>'width:200px')); ?>
					</li>
					<li>
		...
		$this->widget('iPhoenixGridView', array(
			...
			'columns'=>array(
				...
				array(
					'name'=>'visits',
					'headerHtmlOptions'=>array('width'=>'5%','class'=>'table-test'),		
				),
				array(
					...
					(
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/test/reverseStatus", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/test/reverseNew", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/test/reverseHome", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
					...
					'headerHtmlOptions'=>array('width'=>'10%','class'=>'table-test'),
				),    	   										   	   
				array(
					...
					(
						'update' => array(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/test/update",array("id"=>$data->id))'
						),
						'delete' => array(
							'label'=>iPhoenixLang::admin_t('Delete','main'),
							'url'=>'iPhoenixUrl::createUrl("admin/test/delete",array("id"=>$data->id))'
						),
						'copy' => array
						(
							'label'=>iPhoenixLang::admin_t('Copy','main'),
							'imageUrl'=>Yii::app()->theme->baseUrl.'/images/copy.png',
							'url'=>'iPhoenixUrl::createUrl("admin/test/copy", array("id"=>$data->id))',
						),
						'clipboard' => array
						(
			...
			'summaryText'=>'{count} '.iPhoenixLang::admin_t('Testing'),
...
<script type="text/javascript">
	$("body").ajaxComplete(function() {
		$("a[class^=edit-order-view-]").editable("<?php echo iPhoenixUrl::createUrl('admin/test/edit')?>", {
