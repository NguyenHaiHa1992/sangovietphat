<?php $form=$this->beginWidget('CActiveForm', array('id'=>'category-form','enableAjaxValidation'=>true,'clientOptions'=>array('validationUrl'=>$this->createUrl('audioCategory/validate')))); ?>	
			...
			<div class="fl" style="width:500px;">
				<ul>
                    ...
                    <li>
                        ...
                        <?php
                        	...
                        	foreach ($model->list_nodes as $id=>$level){
                        	 	$node=AudioCategory::model()->findByPk($id);
								$view = "";
								for($i=1;$i<$level;$i++){
									$view .="--";
								}
                    ...
                    <li>
                        ...
                        <?php
                        	$list=array(AudioCategory::STATUS_ENABLE=>'Hiện',AudioCategory::STATUS_DISABLE=>'Ẩn');
