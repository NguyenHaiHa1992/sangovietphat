...
<div id="main-content" class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon"><span><?php echo iPhoenixLang::admin_t('Update audio');?></span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content form">
		<div>
            ...
            <input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('List audios');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/audio')?>'"/>
			...
			<ul>
				...
				<div class="row none">
					<li>
						...
						<a title="Chọn bài viết" onclick="showPopUp('list_suggest_audio');return false;" id="btn-add-product" class="button" style="width: 100px;text-decoration: none;">Chọn</a>			
					</li>
				</div>	
				<div class="row">
					<li>
						<?php echo $form->labelEx($model,'file_id'); ?>
						<?php echo $this->renderPartial('/file/_signupload_audio', array('model'=>$model,'attribute'=>'file_id')); ?>		
...
<!--end inside content-->
<?php	echo $this->renderPartial('_list_suggest_audio', 
								array(
									'class_checkbox'=>'SuggestAudio',
									'class'=>'list_suggest_audio',
