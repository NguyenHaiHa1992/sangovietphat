...
?>
	...
	<div id="main-content" class="folder top">
		...
		<div class="folder-header">
			<h1><?php echo iPhoenixLang::admin_t('Audio management');?></h1>
			<div class="header-menu">
				<ul>
					<li class="ex-show"><a class="activities-icon"><span><?php echo iPhoenixLang::admin_t('List audio');?></span></a></li>
				</ul>
			</div>
		</div>
		<!--end title-->
		<div class="folder-content">
            <div>
            	<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('Audio categories');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/audioCategory/index')?>'"/>
            	<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('Add audio');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/audio/create')?>'"/>
                ...
                <div class="fr" style="width:430px;">
                    <ul>                   
	                    <li>
							...
							<?php echo $form->dropDownList($model,'status',array(''=>'All', 0=>'Ẩn',1=>'Hiện'),array('style'=>'width:200px')); ?>
						</li> 	                 
						<li>
							<?php echo $form->label($model,'new',array('style'=>'width:200px')); ?>
							<?php echo $form->dropDownList($model,'new',array(''=>'All', 1=>'Hiển thị ở mục bài viết mới'),array('style'=>'width:200px')); ?>
						</li> 
						<li>
							<?php echo $form->label($model,'home',array('style'=>'width:200px')); ?>
							<?php echo $form->dropDownList($model,'home',array(''=>'All', 1=>'Hiển thị ở trang chủ'),array('style'=>'width:200px')); ?>
						</li> 
                    </ul>
                </div>
                <div>
			...
			$this->widget('iPhoenixGridView', array(
  				...
  				'columns'=>array(
					array(
						...
						'checked'=>'in_array($data->id,Yii::app()->session["checked-audio-list"])'
    				),			
    				array(
						'name'=>'name',
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/audio/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/audio/reverseNew", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/audio/reverseHome", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
    					...
    					(
    						'update' => array(
    							...
    							'url'=>'iPhoenixUrl::createUrl("admin/audio/update",array("id"=>$data->id))'
    						),
        					'delete' => array(
    							'label'=>iPhoenixLang::admin_t('Delete','main'),
    							'url'=>'iPhoenixUrl::createUrl("admin/audio/delete",array("id"=>$data->id))'
    						),
    						'copy' => array
    						(
            					'label'=>iPhoenixLang::admin_t('Copy','main'),
            					'imageUrl'=>Yii::app()->theme->baseUrl.'/images/copy.png',
            					'url'=>'iPhoenixUrl::createUrl("admin/audio/copy", array("id"=>$data->id))',
        					),
        					'clipboard' => array
    						(
  				...
  				'summaryText'=>'{count} '.iPhoenixLang::admin_t('Audio'),
	...
	<script type="text/javascript">
		$("body").ajaxComplete(function() {
			$("a[class^=edit-order-view-]").editable("<?php echo iPhoenixUrl::createUrl('admin/audio/edit')?>", {
