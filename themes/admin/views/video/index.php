...
?>
	...
	<div id="main-content" class="folder top">
		...
		<div class="folder-content">
            <div>
            	...
            	<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('Add video');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/video/create')?>'"/>
                ...
                <div class="fr" style="width:430px;">
                    <ul>                   
						...
						<li>
							...
							<?php echo $form->dropDownList($model,'new',array(''=>iPhoenixLang::admin_t('All','main'), 1=>iPhoenixLang::admin_t('Display in new box')),array('style'=>'width:200px')); ?>
						</li> 
						<li>
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/video/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/video/reverseNew", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/video/reverseHome", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
    					...
    					(
    						'update' => array(
    							...
    							'url'=>'iPhoenixUrl::createUrl("admin/video/update",array("id"=>$data->id))'
    						),
        					'delete' => array(
    							'label'=>iPhoenixLang::admin_t('Delete','main'),
    							'url'=>'iPhoenixUrl::createUrl("admin/video/delete",array("id"=>$data->id))'
    						),
    						'copy' => array
    						(
            					'label'=>iPhoenixLang::admin_t('Copy','main'),
            					'imageUrl'=>Yii::app()->theme->baseUrl.'/images/copy.png',
            					'url'=>'iPhoenixUrl::createUrl("admin/video/copy", array("id"=>$data->id))',
        					),
        					'clipboard' => array
    						(
	...
	<script type="text/javascript">
		$("body").ajaxComplete(function() {
			$("a[class^=edit-order-view-]").editable("<?php echo iPhoenixUrl::createUrl('admin/video/edit')?>", {
