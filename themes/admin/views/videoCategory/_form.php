<?php $form=$this->beginWidget('CActiveForm', array('id'=>'category-form','enableAjaxValidation'=>true,'clientOptions'=>array('validationUrl'=>$this->createUrl('videoCategory/validate')))); ?>	
			...
			<div class="fl" style="width:500px;">
				<ul>
                    ...
                    <li>
                        ...
                        <?php
                        	...
                        	foreach ($model->list_nodes as $id=>$level){
                        	 	$node=VideoCategory::model()->findByPk($id);
								$view = "";
								for($i=1;$i<$level;$i++){
									$view .="--";
								}
                    ...
                    <li>
                        ...
                        <?php
                        	$list=array(VideoCategory::STATUS_ENABLE=>'Show',VideoCategory::STATUS_DISABLE=>'Hide');
					...
					<div class="row">
                   	...
                   	<li>
    					...
    					if($action=="update") 
                    	{   
    						echo '<input type="submit" value="Create new category" style="margin-left:10px; width:125px;" id="create-category" class="button">'; 
                    	}
    					?>  
                    </li>
				</ul>
