...
<div id="main-content" class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li class="ex-show"><a class="activities-icon"><span><?php echo iPhoenixLang::admin_t('List introductions');?></span></a></li>
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content">
		...
		Yii::app()->clientScript->registerScript('search', "
			$('#intro-search').submit(function(){
			$.fn.yiiGridView.update('intro-list', {
				data: $(this).serialize()});
				return false;
			});");
		?>
		<div class="box-search">            
			...
			<?php $form=$this->beginWidget('CActiveForm', array('method'=>'get','id'=>'intro-search')); ?>
			<!--begin left content-->
			<div class="fl" style="width:600px;">
				<ul>
					...
					<?php 
					$list=array(''=>iPhoenixLang::admin_t('All introduction categories'));
			...
			<div class="fr" style="width:600px;">
				<ul>                   
					...
					<li>
						...
						<?php echo $form->dropDownList($model,'new',array(''=>iPhoenixLang::admin_t('All','main'), 1=>iPhoenixLang::admin_t('Display in new intro')),array('style'=>'width:200px')); ?>
					</li> 
					<li>
						<?php echo $form->label($model,'home',array('style'=>'width:200px')); ?>
						<?php echo $form->dropDownList($model,'home',array(''=>iPhoenixLang::admin_t('All','main'), 1=>iPhoenixLang::admin_t('Display in headline')),array('style'=>'width:200px')); ?>
					</li> 
				</ul>
			</div>
			<div>
		...
		$this->widget('iPhoenixGridView', array(
			...
			'columns'=>array(
				array(
					...
					'checked'=>'in_array($data->id,Yii::app()->session["checked-intro-list"])'
				),			
				array(
					'name'=>'title',
				...
				array(
					'name'=>'visits',
					'headerHtmlOptions'=>array('width'=>'5%','class'=>'table-intro'),		
				),
				array(
					...
					(
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/intro/reverseStatus", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/intro/reverseNew", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/intro/reverseHome", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
					...
					'headerHtmlOptions'=>array('width'=>'10%','class'=>'table-intro'),
				),    	   										   	   
				array(
					...
					(
						'update' => array(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/intro/update",array("id"=>$data->id))'
						),
						'delete' => array(
							'label'=>iPhoenixLang::admin_t('Delete','main'),
							'url'=>'iPhoenixUrl::createUrl("admin/intro/delete",array("id"=>$data->id))'
						),
						'copy' => array
						(
							'label'=>iPhoenixLang::admin_t('Copy','main'),
							'imageUrl'=>Yii::app()->theme->baseUrl.'/images/copy.png',
							'url'=>'iPhoenixUrl::createUrl("admin/intro/copy", array("id"=>$data->id))',
						),
						'clipboard' => array
						(
			...
			'summaryText'=>'{count} '.iPhoenixLang::admin_t('Intro'),
...
<script type="text/javascript">
	$("body").ajaxComplete(function() {
		$("a[class^=edit-order-view-]").editable("<?php echo iPhoenixUrl::createUrl('admin/intro/edit')?>", {
