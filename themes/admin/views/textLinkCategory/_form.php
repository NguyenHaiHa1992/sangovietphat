<?php $form=$this->beginWidget('CActiveForm', array('id'=>'category-form','enableAjaxValidation'=>true,'clientOptions'=>array('validationUrl'=>$this->createUrl('textLinkCategory/validate')))); ?>	
...
<div class="fl" style="width:500px;">
	<ul>
		...
		<div class="row">
		  ...
		  <div class="row" <?php if(TextLinkCategory::MAX_RANK == 1) echo'style="display:none"'?>>
		<li>
			<?php echo $form->labelEx($model,'parent_id'); ?>
			<?php
				$view_parent_nodes=array('0'=>'Original');
				foreach ($model->list_nodes as $id=>$level){
					$node=TextLinkCategory::model()->findByPk($id);
					$view = "";
					for($i=1;$i<$level;$i++){
						$view .="--";
					}
		...
		<li>
			...
			<?php
				$list=array(TextLinkCategory::STATUS_ENABLE=>'Show',TextLinkCategory::STATUS_DISABLE=>'Hide');
