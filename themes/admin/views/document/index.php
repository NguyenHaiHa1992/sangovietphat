...
?>
	...
	<div id="main-content" class="folder top">
		...
		<div class="folder-header">
			...
			<div class="header-menu">
				<ul>
					<li class="ex-show"><a class="activities-icon" href=""><span>List documents</span></a></li>
				</ul>
			</div>
		</div>
		<!--end title-->
		<div class="folder-content">
         ...
         <?php 
			Yii::app()->clientScript->registerScript('search', "
				...
				$.fn.yiiGridView.update('document-list', {
					data: $(this).serialize()});
					return false;
				});");
			?>
            <div class="box-search">            
                <h2>Search</h2>
                <?php $form=$this->beginWidget('CActiveForm', array('method'=>'get','id'=>'document-search')); ?>
                <!--begin left content-->
                <div class="fl" style="width:600px;">
                    <ul>
                        <li>
                         	...
                         	'model'=>$model,
                         	'attribute'=>'name',
							'url'=>array('document/suggestName'),
							'htmlOptions'=>array(
								'style'=>'width:200px;',
								),
						)); ?>								
                        ...
                        <?php 
						$list=array(''=>'All document categories');
                ...
                <div class="fr" style="width:600px;">
                    <ul>  
	                	 <li>
							...
							<?php $form->dropDownList($model,'status',array(''=>'All', 0=>'Hide',1=>'Show'),array('style'=>'width:200px')); ?>
						</li> 	                 
						<li>
							<?php echo $form->label($model,'new',array('style'=>'width:200px')); ?>
							<?php echo $form->dropDownList($model,'new',array(''=>'All', 1=>'Display in new document'),array('style'=>'width:200px')); ?>
						</li> 
						<li>
							<?php echo $form->label($model,'home',array('style'=>'width:200px')); ?>
							<?php echo $form->dropDownList($model,'home',array(''=>'All', 1=>'Display homepage'),array('style'=>'width:200px')); ?>
						</li> 
                    </ul>
                </div>
                <div>
			...
			$this->widget('iPhoenixGridView', array(
  				...
  				'columns'=>array(
					array(
						...
						'checked'=>'in_array($data->id,Yii::app()->session["checked-document-list"])'
    				),			
    				array(
						'name'=>'name',
					...
					array(
    					...
    					(
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/document/reverseStatus", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/document/reverseNew", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
    						...
    						(
            					...
            					'url'=>'iPhoenixUrl::createUrl("admin/document/reverseHome", array("id"=>$data->id))',
    							'click'=>'function(){
									var th=this;									
									jQuery.ajax({
										type:"POST",
					...
					array(
    					...
    					(
    						'update' => array(
    							'label'=>'Update',
    							'url'=>'iPhoenixUrl::createUrl("admin/document/update",array("id"=>$data->id))'
    						),
        					'delete' => array(
    							'label'=>'Delete',
    							'url'=>'iPhoenixUrl::createUrl("admin/document/delete",array("id"=>$data->id))'
    						),
    						'copy' => array
    						(
            					'label'=>'Copy document',
            					'imageUrl'=>Yii::app()->theme->baseUrl.'//images/copy.png',
            					'url'=>'iPhoenixUrl::createUrl("admin/document/copy", array("id"=>$data->id))',
        					),
        					'clipboard' => array
    						(
	...
	<script type="text/javascript">
		$("body").ajaxComplete(function() {
			$("a[class^=edit-order-view-]").editable("<?php echo iPhoenixUrl::createUrl('admin/document/edit')?>", {
