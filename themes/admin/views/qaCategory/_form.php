<?php $form=$this->beginWidget('CActiveForm', array('id'=>'category-form','enableAjaxValidation'=>true,'clientOptions'=>array('validationUrl'=>$this->createUrl('qaCategory/validate')))); ?>	
...
<div class="fl" style="width:500px;">
	<ul>
		...
		<div class="row">
		  ...
		  <div class="row" <?php if(QaCategory::MAX_RANK == 1) echo'style="display:none"'?>>
		<li>
		...
		<li>
			...
			<?php
				$list=array(QaCategory::STATUS_ENABLE=>'Show',QaCategory::STATUS_DISABLE=>'Hide');
