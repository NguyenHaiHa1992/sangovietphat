<?php $form=$this->beginWidget('CActiveForm', array('id'=>'category-form','enableAjaxValidation'=>true,'clientOptions'=>array('validationUrl'=>$this->createUrl('newsCategory/validate')))); ?>	
...
<div class="fl" style="width:500px;">
	<ul>
		...
		<div class="row">
		  ...
		  <div class="row" <?php if(NewsCategory::MAX_RANK == 1) echo'style="display:none"'?>>
		<li>
			<?php echo $form->labelEx($model,'parent_id'); ?>
			<?php
				$view_parent_nodes=array('0'=>'Original');
				foreach ($model->list_nodes as $id=>$level){
					$node=NewsCategory::model()->findByPk($id);
					$view = "";
					for($i=1;$i<$level;$i++){
						$view .="--";
					}
		...
		<li>
			...
			<?php
				$list=array(NewsCategory::STATUS_ENABLE=>'Show',NewsCategory::STATUS_DISABLE=>'Hide');
