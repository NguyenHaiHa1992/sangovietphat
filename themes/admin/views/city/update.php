...
<div id="main-content" class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li><a class="header-menu-active new-icon"><span><?php echo iPhoenixLang::admin_t('Update city');?></span></a></li>					
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content form">
		<div>
			<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('List cities');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/city')?>'"/>
			...
			<ul>	
				...
				<div class="row">
					<li>
						...
						<?php echo $form->dropDownList($model,'type',array('0'=>iPhoenixLang::admin_t('Province/City'),'1'=>iPhoenixLang::admin_t('District')),array('style'=>'width:300px;','maxlength'=>'256')); ?>	
				...
				<div class="row">
					<li>
                        ...
                        <?php
                        	$view_parent_nodes=array('0'=>iPhoenixLang::admin_t('Add','main'));
