...
<div class="<?php echo $class;?> popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title">List videos</div>
				...
				<ul>
					...
					?>
					 ...
					 <li>
					  ...
					  <?php 
						$list=array(''=>'All video categories');
					...
					<li>
					  <?php 
							$this->widget('iPhoenixGridView', array(
				  				...
				  				'summaryText'=>'{count} videos',
				 	 			'pager'=>array('class'=>'CLinkPager','header'=>'','prevPageLabel'=>'< Previous','nextPageLabel'=>'Next >','htmlOptions'=>array('class'=>'pages fr')),
				 	 			)); ?>
					</li>
					<div class="clear"></div>
					<li>
						<input  class="fr button" id="update_suggest_video" type="submit" value="Update" style="width:100px; margin-top:10px; margin-right:5px;" />
...
jQuery(window).load(function() {
	$("#update_suggest_video").click(
  		function(){  	
  			name=$("#video-list thead :checkbox").attr("name");
			...
			jQuery.ajax({
				...
				success:function(data){
					$('#Product_tmp_suggest_video').val(data);
					hidenPopUp('<?php echo $class?>');
				},
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/product/updateSuggestVideo');?>',
				});
			return false;
		});
});
