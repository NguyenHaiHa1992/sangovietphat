...
<div class="<?php echo $class;?> popup-wrapper">
	<div class="main-popup">
		...
		<div class="content-popup">
			<div class="popup_title">Danh sách sản phẩm bán</div>
			<div class="folder-content" style="max-height: 600px;: 600px">
				<ul>
					<?php 
						Yii::app()->clientScript->registerScript('search-store-suggest', "
					...
					<li>
						...
						<?php echo $form->dropDownList($suggest,'cat_id',$list,array('style'=>'width:200px','name'=>'SuggestProduct[cat_id]')); ?>
					</li>            
					<li>
					<label>&nbsp;</label> 
					<input type="submit" class="button" value="Lọc sản phẩm">
					</li>
					<?php $this->endWidget(); ?>	
					<li>
					  <?php 
  		...
  		function(){  	
			...
			jQuery.ajax({
				...
				success:function(data){
					$('#Store_tmp_product_ids').val(data);
					hidenPopUp('<?php echo $class?>');
				},
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/store/updateSellProduct');?>',
				});
			return false;
		});
});
