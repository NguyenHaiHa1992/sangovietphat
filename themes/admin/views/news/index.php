...
<div id="main-content" class="folder top">
	...
	<div class="folder-header">
		...
		<div class="header-menu">
			<ul>
				<li class="ex-show"><a class="activities-icon"><span><?php echo iPhoenixLang::admin_t('List news');?></span></a></li>
			</ul>
		</div>
	</div>
	<!--end title-->
	<div class="folder-content">
		<div>
			<input type="button" class="button" value="<?php echo iPhoenixLang::admin_t('News categories');?>" style="width:180px;" onClick="parent.location='<?php echo iPhoenixUrl::createUrl('admin/NewsCategory/index')?>'"/>
		...
		<div class="box-search">            
			...
			<div class="fl" style="width:600px;">
				<ul>
					...
					<?php 
					$list=array(''=>iPhoenixLang::admin_t('All news categories'));
			...
			<div class="fr" style="width:600px;">
				<ul>                   
					...
					<li>
						...
						<?php echo $form->dropDownList($model,'new',array(''=>iPhoenixLang::admin_t('All','main'), 1=>iPhoenixLang::admin_t('Display in new news','main')),array('style'=>'width:200px')); ?>
					</li> 
					<li>
						<?php echo $form->label($model,'home',array('style'=>'width:200px')); ?>
						<?php echo $form->dropDownList($model,'home',array(''=>iPhoenixLang::admin_t('All','main'), 1=>iPhoenixLang::admin_t('Display on home page','main')),array('style'=>'width:200px')); ?>
					</li> 
				</ul>
			</div>
			<div>
		...
		$this->widget('iPhoenixGridView', array(
				...
				array(
					...
					(
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/news/reverseStatus", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/news/reverseNew", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
						...
						(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/news/reverseHome", array("id"=>$data->id))',
							'click'=>'function(){
								var th=this;									
								jQuery.ajax({
									type:"POST",
				...
				array(
					...
					(
						'update' => array(
							...
							'url'=>'iPhoenixUrl::createUrl("admin/news/update",array("id"=>$data->id))'
						),
						'delete' => array(
							'label'=>iPhoenixLang::admin_t('Delete','main'),
							'url'=>'iPhoenixUrl::createUrl("admin/news/delete",array("id"=>$data->id))'
						),
						'copy' => array
						(
							'label'=>iPhoenixLang::admin_t('Copy','main'),
							'imageUrl'=>Yii::app()->theme->baseUrl.'/images/copy.png',
							'url'=>'iPhoenixUrl::createUrl("admin/news/copy", array("id"=>$data->id))',
						),
						'clipboard' => array
						(
			...
			'summaryText'=>'{count} '.iPhoenixLang::admin_t('News'),
...
<script type="text/javascript">
	$("body").ajaxComplete(function() {
		$("a[class^=edit-order-view-]").editable("<?php echo iPhoenixUrl::createUrl('admin/news/edit')?>", {
