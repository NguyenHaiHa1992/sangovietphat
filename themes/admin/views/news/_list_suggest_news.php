				...
				<ul>
					...
					?>
					 ...
					 <li>
					  ...
					  <?php 
						$list=array(''=>'All news categories');
					...
					<li>
						...
						<?php echo $form->dropDownList($suggest,'cat_id',$list,array('style'=>'width:200px','name'=>'SuggestNews[cat_id]')); ?>
					</li>            
					<li>
					<label>&nbsp;</label> 
	...
	$("#update_suggest").click(
  		function(){  	
			...
			jQuery.ajax({
				...
				type:'POST',
				url:'<?php echo iPhoenixUrl::createUrl('admin/news/updateSuggest');?>',
				});
			return false;
		});
});
